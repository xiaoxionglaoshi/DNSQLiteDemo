...
struct DNUsersInfoManager {
    private var db: Connection!
    private let users = Table("users") //表名
    private let id = Expression<Int>("id") // 主键
    private let username = Expression<String>("username")
    private let userage = Expression<String>("userage")
    private let usersex = Expression<String>("usersex")
    private let userid = Expression<String>("userid")
    private let useremail = Expression<String>("useremail")
